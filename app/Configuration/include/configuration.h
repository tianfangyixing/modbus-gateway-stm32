...
#define CONFIGURATION_HOSTNAME_BUFFER_SIZE UINT16_C(256)
#define CONFIGURATION_CLIENT_ID_MAX_LENGTH UINT16_C(256)
#define CONFIGURATION_USERNAME_MAX_LENGTH UINT16_C(256)
#define CONFIGURATION_PASSWORD_MAX_LENGTH UINT16_C(256)
...
{
    uint16_t length;
    /* NUL at bytes[length] and spare bytes are not encoded; content remains at most 253 bytes. */
    uint8_t bytes[CONFIGURATION_HOSTNAME_BUFFER_SIZE];
